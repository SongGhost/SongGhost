...
**First-playlist special pack (Pass 4):** After the session welcome / opener, Song 1 plays at 100%. While it plays, two-ahead warms a dedicated pack for the Song 1 → Song 2 gap: lore recap (“That was [Song 1]…”) then an up-next tease (“Up next [Song 2]…”) using the live Host Studio lore tier / persona / voice. Song 2 then starts at 100%. This pack is **one-shot** — skip during Song 1, station change, or Host Studio script/voice edits abort it (Pass 1). Later mid-session transitions follow pace copy cadence: Every Song leads with what's next; Natural Pace / Long Breaks may still open with “You just heard / That was” after silent songs. Never talk over music.
