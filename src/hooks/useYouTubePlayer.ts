...
export function useYouTubePlayer({
  ...
  /** Set on user gesture; cleared once the player confirms unmuted playback. */
  ...
  }, [containerRef, loadVideo, syncPlayerAudio, applyUnlock]);
  ...
  }, [isPlaying, syncPlayerAudio, applyUnlock]);
