  ...
  return (
    <main className="min-h-screen flex flex-col">
      <ControlDeck accentColor={accentColor}>
        {/* Header deck: artwork, now playing, DJ host */}
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mb-3">
          <div className="flex flex-row items-start gap-3 min-w-0 flex-1">
            <FrequencyDial frequency={displayFrequency} compact />
            <div className="flex-1 min-w-0 space-y-2">
              ...
              />
              <div>
                <p className="text-[10px] tracking-widest text-label uppercase mb-1">
                  DJ Host
                </p>
                <PersonaSelector />
              </div>
              {nowPlaying.youtubeId && (
                <button
                  ...
                  className="flex items-center gap-1 text-[10px] sm:text-xs text-label-muted hover:text-red-400 transition-colors"
                >
                  <Heart
          ...
          <div className="hidden sm:block shrink-0 text-right text-[10px] text-label-muted max-w-[140px]">
            <p className="uppercase tracking-widest mb-0.5">Active Station</p>
            <p className="text-xs text-display leading-snug">{activeStation.name}</p>
            <p className="mt-1">
        ...
        {/* Progress bar — strict width constraint */}
        <div className="w-full max-w-full overflow-hidden min-w-0 mb-3">
          <AudioPlayer
            ref={playerRef}
        ...
        {/* Transport + VU meter */}
        <div className="flex flex-col md:flex-row items-center gap-3 md:gap-6 mb-3">
          <div className="w-full md:flex-1 min-w-0">
            <VUMeter active={isPlaying} compact />
          </div>
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full md:w-auto shrink-0">
            <TransportControls
              isPlaying={isPlaying}
        ...
        {/* Quick connectors + Artist Radio + AI Curator */}
      ...
      <div className="station-scroll-area flex-1 overflow-y-auto px-2 sm:px-4 md:px-6 py-4 sm:py-6">
