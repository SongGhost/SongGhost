...
export default function FrequencyDial({ frequency, compact }: FrequencyDialProps) {
  const rotation = ((frequency - 88) / 20) * 270 - 135;
  const dialSize = compact ? "h-20 w-20 sm:h-24 sm:w-24" : "h-36 w-36";
  const needleH = compact ? "h-8" : "h-14";
