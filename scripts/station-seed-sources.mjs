...
export const STATION_SEED_SOURCES = {
  ...
  "bossa-nova": [
    ...
    ["Antonio Carlos Jobim", "The Waters of March"],
  ...
  "gospel-spirit": [
    ...
    ["Andraé Crouch", "Soon and Very Soon"],
  ...
  "chiptune-8bit": [
    ...
    ["Sabrepulse", "Turbo Love"],
    ["Sabrepulse", "Flash Forward"],
    ["RushJet1", "Shinobeat"],
    ["RushJet1", "Deep in the Mines"],
    ["Jake Kaufman", "Strike the Earth!"],
    ["Jake Kaufman", "Flowers of Antimony"],
    ["Jake Kaufman", "A Thousand Leagues Below"],
    ["Chipzel", "Spectra"],
    ["Chipzel", "Focus"],
    ["Fearofdark", "Analog Horseman"],
    ["Fearofdark", "Fast Life"],
    ["Zircon", "Crystallized"],
    ["Kubbi", "Ember"],
    ["Kubbi", "Overworld"],
    ["Dubmood", "Insert Coin"],
    ...
    ["Takashi Tateishi", "Dr. Wily Stage 1"],
    ["Masato Nakamura", "Green Hill Zone"],
    ["Toby Fox", "Megalovania"],
    ["Grant Kirkhope", "Spiral Mountain"],
  ],
  ...
  "vaporwave-aesthetic": [
    ...
    ["Cat System Corp.", "Veni, Vidi, Emi"],
    ["Cat System Corp.", "8:46 AM"],
    ["Cat System Corp.", "Downtown"],
    ["Desert Sand Feels Warm at Night", "Tangerine Ecstasy"],
    ["t e l e p a t h", "永遠の愛"],
    ...
    ["S U R F I N G", "Liquid Air"],
    ["Infinity Frequencies", "Computer Death"],
    ["Washed Out", "Eyes Be Closed"],
    ["Neon Indian", "Deadbeat Summer"],
    ["Blank Banshee", "Cyanide"],
    ["HOME", "Come Back Down"],
    ["Yung Bae", "Bad Boy"],
    ["Saint Pepsi", "Private Caller"],
    ["George Clanton", "It So Easy"],
    ["Windows96", "Layer 6"],
    ["luxury elite", "Late Nite"],
    ["Toro y Moi", "Talamak"],
